  ...
  return (
    <div className="App" lang="en">
      <Head>
        ...
        <meta httpEquiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' https://img.icons8.com data:; connect-src 'self' https://api.whatsapp.com; frame-src 'none';" />
        <script
      ...
      <section id="home" className="hero">
        <div className="container">
          <div className="hero-content">
            ...
            <Link href="#contact" className="cta-button">{t.buyNow}</Link>
          </div>
          <div className="hero-image">
            <div className="domain-card">
              <div className="domain-icon">
                <Image 
                  src="https://img.icons8.com/fluency/96/null/bitcoin.png" 
                  alt="Bitcoin Icon"
                  width={96}
                  height={96}
                />
      ...
      <section className="cta-section">
        <div className="container">
          ...
          <Link href="#contact" className="cta-button">{t.secureNow}</Link>
        </div>
      </section>
